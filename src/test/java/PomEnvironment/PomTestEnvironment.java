...
public class PomTestEnvironment {
    // =============================================
    ...
    // ===========================================================================
    @Given("POM Tool to get {string} test data from source {string} {string}")
    public static void pomToolToManageTestData(String page, String fileName, String tdSource) {
    ...
    //    (can be called from Gherkin)
    // ===========================================================================
    @When("POM Tool to change resolution to {string}")
    public static void pomToolToChangeResolutionTo(String browserSize) {
        switch (browserSize) {
            case "phone":
                teBrowserWidth = 400;
                teBrowserHeight = 768;
    ...
    //    (can be called from Gherkin)
    // ===========================================================================
    @And("POM Tool to print page details")
    public static void pomToolBoxPageDetails() {
        System.out.println("================================================");
    ...
    //    (can be called from Gherkin)
    // ===========================================================================
    @And("POM Tool to print browser size")
    public static void pomToolToPrintBrowserSize() {
    ...
    // ===========================================================================
    @Then("POM Tool to display test environment set up")
    public static void pomToolToDisplayTestEnvironmentSetUp() {
        pomToolBoxPageDetails();
        pomToolToPrintBrowserSize();
    }

    // ===========================================================================
    //  Tool: Display Page Details to Console
    // ===========================================================================
    @And("POM Tool to print all page details {string} source")
    public void pomToolToPrintAllPageDetailsWithSource(String srcFlag) {
    ...
    //          (can be called from Gherkin)
    // ===========================================================================
    @But("POM Tool to check if web element beyond viewport window")
    public static boolean pomToolChecksWebElementNotInViewport(WebElement myElement) {
    ...
    //          (can be called from Gherkin)
    // ===========================================================================
    @And("POM Tool to handle 3rd party alert at {string} with a {string}")
    public static void pomToolHandles3RdPartyAlert(String alertXpath, String alertAction) {
    ...
    //          (called from Gherkin)
    // ===========================================================================
    @And("POM Tool gets element state for {string} with label {string}")
    public static void pomToolGetsWebElementState(WebElement myElement, String elementLabel) {
    ...
    //          (called from Gherkin)
    // -------------------------------------------------------------------------------------------
    @And("POM Tool wait for element with Xpath {string} to appear after {int} secs")
    public static WebElement pomToolWaitForXpath(String thisXpathProvided, String waitType, int waitProvided) {
    ...
    //          (called from Gherkin)
    // ---------------------------------------------------------------------------
    @And("POM Tool wait for element with Xpath {string} to appear")
    public static WebElement pomToolWaitForElementWithXpath(String thisXpathProvided) {
    ...
    //          (called from Gherkin)
    // ---------------------------------------------------------------------------
    public static Map<String, Object> getPomData(String fileName) {
    ...
    //          (called from Gherkin)
    // ---------------------------------------------------------------------------
    public static Map<String, String> getPomStrData(String fileName) {
        String myDataDir = teDataDirectory;
        String myFilename = fileName;
        String myExtension = "yml";
        return new Yaml().load(getStream(myDataDir, myFilename, myExtension));
